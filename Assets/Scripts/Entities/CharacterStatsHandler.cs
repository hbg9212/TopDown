...
public class CharacterStatsHandler : MonoBehaviour
{
    ...
    private void ApplyRangedStats(Func<float, float, float> operation, CharacterStats newModifier)
    {
        ...
        currentRangedAttacks.numberOfProjectilesPreShot = Mathf.CeilToInt(operation(currentRangedAttacks.numberOfProjectilesPreShot, rangedAttacksModifier.numberOfProjectilesPreShot));
